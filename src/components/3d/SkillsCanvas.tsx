    ...
    <Float speed={2} rotationIntensity={1} floatIntensity={1.5}>
      <group position={skill.pos as [number, number, number]}>
        ...
        <mesh scale={hovered ? 1.5 : 1.15}>
          ...
          <meshBasicMaterial color={skill.color} wireframe transparent opacity={hovered ? 0.8 : 0.3} />
        </mesh>
...
export const SkillsCanvas: React.FC<SkillsCanvasProps> = ({ onHoverSkill }) => {
  return (
    <div className="w-full h-[450px] relative pointer-events-auto cursor-grab active:cursor-grabbing">
