...
const timelineEvents = [
  {
    ...
    location: 'Mumbai, IN',
    description: 'Leading frontend architecture, GSAP interactive web components, microservices integration, and mentoring high-performing engineering teams.',
    achievements: [
      'Built interactive web tools boosting user conversion by 140%',
      'Architected state management reducing re-renders by 45%',
      'Spearheaded transition to JavaScript, Next.js & Tailwind CSS',
    ],
    side: 'left',
    badge: 'PRESENT',
    color: '#00D9FF',
